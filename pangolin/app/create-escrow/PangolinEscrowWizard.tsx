...
function fmt(usdc) {
  ...
  return {
    usdc: n.toFixed(2),
    php: (n * PHP_RATE).toLocaleString("en-PH", { minimumFractionDigits: 2 }),
  };
}
...
function Label({ children, hint }) {
  return (
    ...
    >
      ...
      {hint && (
        <span style={{ fontSize: 11.5, color: C.textMuted, fontWeight: 400 }}>
          {hint}
        </span>
      )}
    </div>
  ...
  const variants = {
    coral: {
      ...
      boxShadow: isDisabled
        ? "none"
        : h
          ? `0 12px 40px ${C.coral}40,0 0 0 1px ${C.coral}35`
          : `0 6px 24px ${C.coral}32,0 0 0 1px ${C.coral}22`,
    },
    ghost: {
            ...
            >
              ...
              <div
                style={{
                  ...
                  boxShadow: active
                    ? `0 0 24px rgba(46,175,125,.45),0 0 0 4px rgba(46,175,125,.12)`
                    : done
                      ? `0 0 16px rgba(68,147,66,.3)`
                      : "none",
              ...
              <div
                style={{
                  ...
                  color: active ? C.coral : done ? C.green : C.textMuted,
                  textAlign: "center",
                  whiteSpace: "nowrap",
                }}
              >
                  ...
                  style={{
                    ...
                    background:
                      step > idx + 1
                        ? C.green
                        : step > idx
                          ? `linear-gradient(90deg,${C.green},${C.border})`
                          : C.border,
...
function Step1({ data, setData, onNext }) {
  ...
  const valid =
    ...
    (inviteMode || data.freelancerWallet.trim());
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      <div>
        ...
        <Input
          ...
          placeholder="e.g. Brand identity package for Web3 startup"
        />
      </div>
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Describe the scope, deliverables, style references, and any special requirements..."
          rows={5}
        />
        <div
          style={{
            fontSize: 11.5,
            color: data.description.length >= 30 ? C.green : C.textMuted,
            marginTop: 5,
            textAlign: "right",
          }}
        >
          ...
          {data.description.length < 30 &&
            `(${30 - data.description.length} more needed)`}
        </div>
      </div>
      ...
      <div>
        ...
        {inviteMode ? (
          ...
          >
            ...
            >
              Share a unique link with your freelancer — they'll connect their
              wallet to join this contract.
            </div>
          ...
          <Input
            ...
            onChange={(e) =>
              setData({ ...data, freelancerWallet: e.target.value })
            }
...
function Step2({ data, setData, onNext, onBack }) {
  ...
  const updateMilestone = (i, field, val) =>
    setMilestones(
      milestones.map((m, idx) => (idx === i ? { ...m, [field]: val } : m)),
    );
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        {total > 0 && (
          ...
          >
            ...
            <span style={{ color: C.textMuted }}>
              at current rate (1 USDC ≈ ₱{PHP_RATE})
            </span>
          </div>
        )}
      </div>
      ...
      >
          ...
          <Tooltip tip="Even if a dispute occurs or the client cancels, the freelancer is guaranteed to receive at least this percentage of the total escrow. Pangolin's smart contract enforces this automatically — no exceptions.">
            <div
              style={{
                ...
                height: 18,
                borderRadius: "50%",
                background: "rgba(46,175,125,.2)",
                border: "1px solid rgba(46,175,125,.35)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: 11,
        ...
        <div style={{ marginBottom: 12 }}>
          <input
            ...
            value={minPct}
            onChange={(e) =>
              setData({ ...data, minGuarantee: +e.target.value })
            }
            style={{
              width: "100%",
              accentColor: C.coral,
        ...
        >
          ...
          <div
            style={{ width: 1, height: 48, background: "rgba(46,175,125,.2)" }}
          />
          <div style={{ textAlign: "center" }}>
            <div
              style={{
                ...
                fontWeight: 900,
                letterSpacing: "-.03em",
                color: total > 0 ? C.text : C.textMuted,
              }}
            >
              {total > 0 ? `$${minUSDC}` : "$—"}
            </div>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              {total > 0
                ? `₱${(parseFloat(minUSDC) * PHP_RATE).toLocaleString("en-PH", { minimumFractionDigits: 0 })}`
                : "₱—"}
            </div>
        ...
        >
          ⚡ Smart contract enforced — freelancer receives at least{" "}
          <strong style={{ color: C.coral }}>${minUSDC} USDC</strong> even if a
          dispute is raised or the project is cancelled.
        </div>
      </div>
        ...
        <Toggle
          ...
          sub={
            data.milestonesEnabled
              ? "Milestone-based — released in phases"
              : "Single Payment — released upon completion"
          }
        />
      ...
      <div style={{ display: "flex", gap: 12, marginTop: 4 }}>
        <Btn variant="ghost" size="lg" onClick={onBack}>
          ← Back
        </Btn>
        <Btn
          variant="coral"
  ...
  const Row = ({ label, value, highlight, muted, mono }) => (
    <div
      style={{
        ...
        alignItems: "center",
        padding: "11px 0",
        borderBottom: `1px solid rgba(38,38,58,.6)`,
      }}
    >
      <span
        style={{
      ...
      <span
        style={{
          ...
          letterSpacing: highlight ? "-.03em" : "normal",
        }}
      >
        {value}
      </span>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div
        style={{
          background:
            "linear-gradient(135deg,rgba(29,29,40,.97),rgba(22,22,32,.97))",
          border: `1.5px solid ${C.border}`,
          borderRadius: 18,
          overflow: "hidden",
        }}
      >
        ...
        <div style={{ padding: "6px 22px" }}>
          ...
          <Row
            ...
            value={data.freelancerWallet || "Invite Link"}
            mono
          />
          <Row
            label="Payment Structure"
            value={
              data.milestonesEnabled ? "Milestone-based" : "Single Payment"
            }
          />
        ...
        >
          ...
          <div style={{ fontSize: 12, color: C.textMuted, lineHeight: 1.55 }}>
            Freelancer receives at least this amount even if the project is
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: 12.5, color: C.textSub, lineHeight: 1.6 }}>
            Funds are locked in a Stellar smart contract — visible to both
            parties, controlled by neither until release conditions are met.{" "}
            <strong style={{ color: C.text }}>
              Freelancer is notified automatically upon funding.
            </strong>
          </div>
        </div>
      </div>
      ...
      >
        <div
          ...
          style={{
            ...
            justifyContent: "center",
            transition: "all .15s",
            boxShadow: confirmed ? `0 0 12px rgba(46,175,125,.35)` : "none",
            cursor: "pointer",
          }}
        >
          {confirmed && (
        ...
        <span style={{ fontSize: 13, color: C.textSub, lineHeight: 1.6 }}>
          I confirm the escrow terms above and authorize Pangolin to lock{" "}
          <strong style={{ color: C.text }}>${totalWithFee} USDC</strong> in a
          Stellar smart contract upon submission.
        </span>
      </label>
      ...
      <div style={{ textAlign: "center", fontSize: 12, color: C.textMuted }}>
        Secured by Stellar Network · 3-5 second settlement · 2.5% total platform
        fee
      </div>
    ...
    <div style={{ textAlign: "center", padding: "40px 20px" }}>
      <div
        style={{
          fontSize: 64,
          marginBottom: 20,
          animation: "bounce-in .5s cubic-bezier(.4,0,.2,1)",
        }}
      >
        🎉
      </div>
      ...
      >
        <strong style={{ color: C.text }}>{data.title}</strong> is now live.
        <br />
        Your freelancer has been notified and $
        {(parseFloat(data.totalAmount) * 1.025).toFixed(2)} USDC is locked
        securely on Stellar.
      </div>
      {txHash && (
        <div
          style={{
            background: "rgba(68,147,66,.08)",
            border: "1px solid rgba(68,147,66,.25)",
            borderRadius: 12,
            padding: "12px 18px",
            marginBottom: 20,
            fontSize: 12.5,
      ...
      >
        <Btn variant="coral" size="lg" onClick={onReset}>
          Create Another Escrow
        </Btn>
        <Btn variant="ghost" size="lg" onClick={() => go("/dashboard")}>
          View Dashboard
        </Btn>
      </div>
    </div>
...
export default function PangolinEscrowWizard() {
  ...
  async function lookupFreelancerByWallet(
  ...
  const handleSubmit = async () => {
    ...
    setTxError(null);
    try {
      const amountUsdc = parseAmountToInt(
        data.totalAmount || "0",
        appConfig.assetDecimals,
      );
      ...
      if (escrowId == null)
        throw new Error(
          "Contract did not return an escrow ID. Check explorer and try again.",
        );
      ...
      const freelancerUserId = await lookupFreelancerByWallet(
        data.freelancerWallet,
      );
        ...
        >
          ...
          >
            ...
            {!done && (
              <div style={{ textAlign: "center", marginBottom: 36 }}>
                ...
                <p style={{ fontSize: 14, color: C.textMuted }}>
                  {step === 1
                    ? "Tell us about the commission and who you're working with."
                    : step === 2
                      ? "Set the escrow amount, guarantees, and milestones."
                      : "Double-check everything before locking funds on-chain."}
                </p>
              </div>
            )}
            ...
            <div
              style={{
                background:
                  "linear-gradient(145deg,rgba(24,24,34,.98),rgba(17,17,25,.98))",
                border: `1px solid ${C.border}`,
                borderRadius: 22,
                boxShadow:
                  "0 24px 80px rgba(0,0,0,.6),0 0 0 1px rgba(255,255,255,.03)",
            ...
            {!done && (
              ...
              >
                🔒 Secured by Stellar · End-to-end escrow protection · 2.5%
                platform fee
              </div>
            )}
          </div>
