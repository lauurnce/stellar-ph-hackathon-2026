...
const C = {
  ...
  coral: "#3FD0C9",
  coralDark: "#2EAF7D",
  coralSoft: "rgba(193,246,237,0.12)",
  blue: "#3FD0C9",
  green: "#449342",
  amber: "#F59E0B",
  purple: "#8B5CF6",
...
function ScreenA({
  ...
  const currentMilestone =
    milestones.find((m) => m.status !== "Approved") || milestones[0] || {};
    ...
    <AuthGuard>
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "0 16px 60px" }}>
          ...
          >
            ...
            {files.length === 0 ? (
              <>
                ...
                <div
                  style={{ fontSize: 13, color: C.textMuted, lineHeight: 1.6 }}
                >
                  or{" "}
        ...
        >
          ...
          >
            Client has <strong style={{ color: "#FCD34D" }}>48 hours</strong> to
            review and respond. If no action is taken, payment is auto-released
            to your wallet.
          </span>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 13, fontWeight: 700, color: C.green }}>
          Settled in 3.2 seconds on Stellar
        </span>
      </div>
  ...
  useEffect(() => {
    ...
    async function loadEscrow() {
      const { data, error } = await supabase
        .from("escrows")
        .select(
          "id,title,status,amount_usdc,deadline,client_id,freelancer_id,stellar_contract_id",
        )
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    screen === id
                      ? "inset 0 0 0 1px rgba(46,175,125,.28)"
                      : "none",
