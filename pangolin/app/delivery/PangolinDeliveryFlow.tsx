  ...
  const V =
    {
      ...
      blue: {
        ...
        bd: "none",
        shd: h
          ? "0 10px 36px rgba(63,208,201,.5)"
          : "0 5px 18px rgba(63,208,201,.28)",
      },
      ghost: {
      ...
      green: {
        ...
        bd: "none",
        shd: h
          ? "0 10px 36px rgba(68,147,66,.5)"
          : "0 5px 18px rgba(68,147,66,.28)",
      },
    }[variant] || {};
  return (
    <button
...
function ScreenA({
  ...
  const isLastMilestone =
    ...
    milestones.slice(currentIndex + 1).every((m) => m.status === "completed");
  ...
  const handleSubmit = async () => {
        ...
        err instanceof Error
          ...
          : typeof err === "string"
            ...
            : typeof err?.message === "string"
              ? err.message
              : null;
      if (msg && msg !== "[object Object]" && !/^\[object/i.test(msg))
        return msg;
      // Try JSON, fallback to generic
      try {
        return JSON.stringify(err);
      } catch {
        return "Contract call failed. Check Freighter and try again.";
      }
    };
    ...
    if (!onchainId || !isLastMilestone) {
      ...
      if (onchainStatus === "CREATED") {
        setSubmitting(false);
        setSubmitError(
          "Client hasn't funded this escrow yet. Ask them to fund it first.",
        );
        return;
      }
      if (onchainStatus === "CANCELLED") {
        setSubmitting(false);
        setSubmitError(
          "This escrow was cancelled and cannot accept a delivery.",
        );
        return;
      }
  ...
  return (
    <AuthGuard>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: `1px solid rgba(10,85,96,.6)`,
              borderRadius: 9,
              padding: "7px 14px",
              marginBottom: 18,
              color: C.textSub,
        ...
        <div
          style={{ maxWidth: 640, margin: "0 auto", padding: "0 16px 60px" }}
        >
          <div
            style={{
              display: "flex",
          ...
          >
            <div
              style={{
                ...
                height: 42,
                borderRadius: 13,
                background: `linear-gradient(135deg,${C.coral}25,${C.coral}0A)`,
          ...
          >
              ...
              {Array.from({ length: milestoneCount }, (_, idx) => (
                <div
                  ...
                  style={{
                    ...
                    background:
                      idx < milestoneStep
                        ? `linear-gradient(135deg,${C.coral},${C.coralDk})`
                        : C.elevated,
                    border:
                      idx < milestoneStep ? "none" : `1px solid ${C.border}`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 9,
                    fontWeight: 800,
                    color: idx < milestoneStep ? "#fff" : C.textMuted,
                  }}
                >
                  {idx + 1 === milestoneStep
                    ? "●"
            ...
            <div>
              ...
              <span style={{ fontSize: 13, color: C.textSub, marginLeft: 6 }}>
                {milestoneName}
              </span>
            </div>
            <div
            ...
            >
              ${milestoneAmount.toFixed(2)} USDC
            </div>
          </div>
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            >
              File Upload{" "}
              <span
                style={{ fontSize: 11.5, color: C.textMuted, fontWeight: 400 }}
              >
                (max 5 files)
              </span>
            </div>
              ...
              {dragging && (
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(135deg,rgba(46,175,125,.08),transparent,rgba(46,175,125,.08))",
                ...
                <>
                  ...
                  <div
                    style={{
                      fontSize: 15,
                      fontWeight: 700,
                      color: dragging ? C.coral : C.text,
                      marginBottom: 6,
                    }}
                  >
                    {dragging
                      ? "Drop to upload"
                      : "Drag & drop your deliverables"}
                  </div>
                  <div
                    style={{
                      fontSize: 13,
                  ...
                  >
                    ...
                    <br />
                    ZIP, PDF, PNG, Figma exports, videos — anything
                  </div>
                  <div
                    style={{
                      display: "inline-flex",
                      ...
                      border: "1px solid rgba(63,208,201,.2)",
                      borderRadius: "100px",
                      padding: "5px 14px",
                      fontSize: 12,
                      color: "#7ECFC6",
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ fontSize: 11.5, color: C.textMuted, marginTop: 6 }}>
              Figma, Google Drive, Notion, Dropbox — any public link works
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <div
                style={{ fontSize: 12.5, color: C.textSub, lineHeight: 1.65 }}
              >
                Your file's SHA-256 hash will be{" "}
                <strong style={{ color: C.text }}>
                  timestamped on the Stellar blockchain
                </strong>{" "}
                the moment you submit — creating an immutable, verifiable record
                of exactly when you delivered. This protects you in any future
                dispute.
              </div>
            </div>
          </div>
              ...
              >
                <span
                  style={{
                    fontSize: 13,
                    fontWeight: 600,
                    color: phase === "done" ? C.green : C.textSub,
                  }}
                >
                ...
                <span
                  style={{
                    fontSize: 13,
                    fontWeight: 700,
                    color: phase === "done" ? C.green : C.coral,
                  }}
                >
                  {progress}%
                </span>
              ...
              >
                <div
                  style={{
                    ...
                    background:
                      phase === "done"
                        ? `linear-gradient(90deg,${C.green},#7ECFC6)`
                        : `linear-gradient(90deg,${C.coral},#3FD0C9)`,
                    width: `${progress}%`,
                    boxShadow: `0 0 12px ${phase === "done" ? "rgba(68,147,66,.6)" : "rgba(46,175,125,.5)"}`,
                    transition:
                      "width .5s cubic-bezier(.4,0,.2,1), background .3s",
                  }}
                />
              </div>
              {/* Phase dots */}
                        ...
                        style={{
                          ...
                          background: done
                            ? active && id !== "done"
                              ? `linear-gradient(135deg,${C.coral},${C.coralDk})`
                              : id === "done" && done
                                ? `linear-gradient(135deg,${C.green},#2EAF7D)`
                                : C.coral
                            : C.elevated,
          ...
          {!submitting ? (
            ...
            <div
              style={{
                padding: "16px",
                background: "rgba(46,175,125,.06)",
                border: `1px solid rgba(46,175,125,.2)`,
                borderRadius: 14,
                textAlign: "center",
              }}
            >
          ...
          >
            ...
            >
              Client has <strong style={{ color: "#FCD34D" }}>48 hours</strong>{" "}
              to review and respond. If no action is taken, payment is
              auto-released to your wallet.
            </span>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(68,147,66,.18) 0%, transparent 70%)",
      ...
      <div
        style={{
          ...
          boxShadow:
            "0 0 40px rgba(68,147,66,.5), 0 8px 32px rgba(68,147,66,.3)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
...
function TxHash({ hash = "—" }) {
  ...
  const display =
    hash && hash.length > 18 ? hash.slice(0, 10) + "…" + hash.slice(-8) : hash;
    ...
    >
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <button
          ...
          style={{
            background: copied ? "rgba(68,147,66,.12)" : "rgba(63,208,201,.1)",
            border: `1px solid ${copied ? "rgba(68,147,66,.3)" : "rgba(63,208,201,.25)"}`,
            borderRadius: 8,
...
function BadgeCard() {
  ...
  return (
    <div
      style={{
        background:
          "linear-gradient(135deg,rgba(139,92,246,.14),rgba(139,92,246,.05))",
    ...
    >
      ...
      >
        <div
          style={{
            ...
            flexShrink: 0,
            background:
              "linear-gradient(135deg,rgba(139,92,246,.3),rgba(139,92,246,.12))",
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 12.5, color: C.textSub }}>
            Delivered on time · Verified on Stellar
          </div>
        </div>
      ...
      >
        ...
        <div style={{ fontSize: 11, color: C.textMuted, marginTop: 4 }}>
          61 more to unlock "Elite Freelancer 💎"
        </div>
      </div>
    </div>
  );
...
function ScreenB({ escrow, milestones, supabase }) {
  ...
  const milestone =
    milestones.find((m) => m.status !== "completed") || milestones[0] || {};
  ...
  const received = Number(
    milestone.amount_usdc ?? milestone.amount ?? escrow?.amount_usdc ?? 0,
  );
  const total = Number(escrow?.amount_usdc ?? received);
  const remaining = Math.max(0, total - received);
  const milestoneLabel = milestone.name
  ...
  useEffect(() => {
    ...
    async function loadProfiles() {
      const [clientRes, freelancerRes, deliveryRes] = await Promise.all([
        ...
        supabase
          .from("deliveries")
          .select("stellar_delivery_tx_hash")
      ...
      if (deliveryRes?.data?.stellar_delivery_tx_hash)
        setTxHash(deliveryRes.data.stellar_delivery_tx_hash);
    }
    ...
    >
      ...
      <div style={{ marginBottom: 6, animation: "fade-up .5s ease .3s both" }}>
        ...
        <div
          style={{
            ...
            lineHeight: 1,
            background:
              "linear-gradient(135deg,#2EAF7D 20%,#3FD0C9 60%,#FFBD99 100%)",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            marginBottom: 8,
          }}
      ...
      <div
        style={{
          ...
          marginTop: 12,
          marginBottom: 28,
          background: "rgba(68,147,66,.1)",
          border: "1px solid rgba(68,147,66,.28)",
          borderRadius: "100px",
          padding: "6px 16px",
        ...
        {[
          ...
          },
          {
            ...
            value: freelancerProfile
              ? `${freelancerProfile.display_name} — ${freelancerProfile.wallet_address?.slice(0, 6)}…${freelancerProfile.wallet_address?.slice(-4)}`
              : "—",
          },
          ...
          <div
            ...
            style={{
              ...
              alignItems: "center",
              padding: "8px 0",
              borderBottom: "1px solid rgba(38,38,58,.5)",
            }}
          >
      ...
      {/* Badge earned */}
      <div
        style={{ marginBottom: 20, animation: "fade-up .5s ease .65s both" }}
      >
        <BadgeCard />
      </div>
      ...
      <div
        style={{
          ...
          flexDirection: "column",
          gap: 12,
          animation: "fade-up .5s ease .75s both",
        }}
      >
        ...
        <Btn
          ...
          size="md"
          fullWidth
          onClick={() => go("/freelancer?view=dashboard")}
        >
          Return
        </Btn>
      </div>
      ...
      >
        <div style={{ fontSize: 12.5, color: C.textSub, lineHeight: 1.6 }}>
          ...
          remaining in escrow · Milestone {milestoneNumber + 1} begins when
          client confirms.
        </div>
      </div>
    </div>
  ...
  useEffect(() => {
    ...
    async function loadEscrow() {
      let query = supabase
        .from("escrows")
        .select(
          "id,title,status,amount_usdc,deadline,client_id,freelancer_id,freelancer_wallet,stellar_contract_id",
        );

      if (wallet?.address) {
        query = query.or(
          `freelancer_id.eq.${user.id},freelancer_wallet.eq.${wallet.address}`,
        );
      } else {
