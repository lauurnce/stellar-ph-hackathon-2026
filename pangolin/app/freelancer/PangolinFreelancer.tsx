...
const PHP = 58.3;
const phpOf = (u) =>
  (parseFloat(u) * PHP).toLocaleString("en-PH", { minimumFractionDigits: 0 });
const formatUsd = (v) =>
  ...
  const V =
    {
      coral: {
        bg: h
          ? "linear-gradient(135deg,#3FD0C9,#228A62)"
          : "linear-gradient(135deg,#2EAF7D,#228A62)",
        col: "#fff",
        bd: "none",
        shd: h
          ? "0 12px 40px rgba(46,175,125,.55),0 0 0 1px rgba(46,175,125,.38)"
          : "0 6px 24px rgba(46,175,125,.35),0 0 0 1px rgba(46,175,125,.25)",
      },
      ghost: {
        bg: h ? "rgba(46,175,125,.07)" : "transparent",
        col: h ? C.coral : C.textSub,
        bd: `1px solid ${h ? "rgba(46,175,125,.3)" : C.border}`,
        shd: "none",
      },
      subtle: {
        bg: h ? C.card : C.elevated,
        col: C.text,
        bd: `1px solid ${h ? C.borderLit : C.border}`,
        shd: "none",
      },
      blue: {
        bg: h
        ...
        bd: "none",
        shd: h
          ? "0 10px 32px rgba(63,208,201,.5)"
          : "0 5px 18px rgba(63,208,201,.3)",
      },
      green: {
        bg: h
          ? "linear-gradient(135deg,#7ECFC6,#2EAF7D)"
          : "linear-gradient(135deg,#449342,#2EAF7D)",
        col: "#fff",
        bd: "none",
        shd: h
          ? "0 10px 32px rgba(68,147,66,.5)"
          : "0 5px 18px rgba(68,147,66,.3)",
      },
      red: {
        bg: h ? "rgba(239,68,68,.14)" : "transparent",
        col: "#F87171",
        bd: `1px solid ${h ? "rgba(239,68,68,.4)" : "rgba(239,68,68,.25)"}`,
        shd: "none",
      },
    }[variant] || {};
  return (
...
function GlassCard({ children, glow, style: sx = {}, nohover }) {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(145deg,rgba(26,26,38,.97),rgba(18,18,28,.97))",
        border: `1px solid ${active && glow ? glow + "50" : C.border}`,
        borderRadius: 18,
        boxShadow:
          active && glow
            ? `0 0 0 1px ${g}18,0 20px 60px rgba(0,0,0,.5),0 0 40px ${g}10`
      ...
      {glow && (
        <div
          style={{
            ...
            right: "20%",
            height: 1,
            background: `linear-gradient(90deg,transparent,${g}35,transparent)`,
            opacity: active ? 1 : 0,
...
function StatusPill({ status }) {
  const M = {
    "In Progress": {
      bg: "rgba(63,208,201,.14)",
      bd: "rgba(63,208,201,.35)",
      tx: "#7ECFC6",
      dot: C.blue,
    },
    "Under Review": {
    ...
    Delivered: {
      bg: "rgba(46,175,125,.14)",
      bd: "rgba(46,175,125,.35)",
      tx: "#FF8C5A",
      dot: C.coral,
    },
    Completed: {
      bg: "rgba(68,147,66,.14)",
      bd: "rgba(68,147,66,.35)",
      tx: "#7ECFC6",
      dot: C.green,
    },
    Disputed: {
  ...
  return (
    <div
      style={{
        ...
        alignItems: "center",
        justifyContent: "center",
        fontSize: emoji ? size * 0.45 : size * 0.34,
        fontWeight: 700,
        color,
        flexShrink: 0,
      }}
...
const BADGES = [
  ...
  },
  {
    ...
    label: "Fast Delivery",
    color: "#3FD0C9",
    desc: "Delivered ahead of deadline",
    earned: true,
  },
  {
    icon: "🔒",
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      if (walletAddress && fresh.address !== walletAddress) {
        setAcceptError(
          "Wrong wallet active in Freighter. Switch to your linked wallet and try again.",
        );
        return;
      }
    ...
    return (
      <div style={{ textAlign: "center", padding: "60px 20px" }}>
        ...
        >
          ...
          <strong style={{ color: C.text }}>{clientName}</strong> has been
          notified and the escrow will be funded shortly.
        </div>
        <Btn variant="coral" size="xl" onClick={onAccept}>
  ...
  return (
    <AuthGuard>
      ...
      <div style={{ maxWidth: 620, margin: "0 auto", padding: "0 16px 60px" }}>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 12.5, color: C.textSub, lineHeight: 1.55 }}>
              Funds are locked in a verifiable smart contract — not held by
              Pangolin. 3–5 second settlement. Your wallet, your money.
            </div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {!declining ? (
            ...
            >
              ...
              <div
                style={{ fontSize: 12.5, color: C.textMuted, marginBottom: 14 }}
              >
                {clientName} will be notified you've declined. This invite link
                will expire.
              </div>
              <div
        ...
        >
          🐧 Pangolin · Zero trust needed — just blockchain · 2.5% flat fee
          charged to client
        </div>
      </div>
    </AuthGuard>
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        >
          Your wallet can't receive USDC payments yet. Add the USDC token in
          Freighter under{" "}
          <strong style={{ color: C.text }}>
            Manage Assets → Add by Contract ID
          </strong>
          .
        </div>
        <div
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontSize: 12,
              fontWeight: 700,
              color: copied ? C.coral : C.textSub,
              fontFamily: C.font,
              whiteSpace: "nowrap",
              flexShrink: 0,
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <Btn variant="subtle" size="sm" onClick={() => setShow(false)}>
            Dismiss
          </Btn>
          <span style={{ fontSize: 12, color: C.textMuted }}>
            After adding, refresh the page to dismiss automatically.
          </span>
        </div>
      </div>
    </div>
  ...
  return (
    <button
      ...
      style={{
        ...
        cursor: "pointer",
        background: active
          ? "linear-gradient(135deg,rgba(46,175,125,.16),rgba(46,175,125,.06))"
          : h
            ? "rgba(255,255,255,.04)"
            : "transparent",
...
function Sidebar({
  ...
  return (
    <aside
      className={isMobile ? "mobile-sidebar-inner" : "desktop-sidebar"}
      style={{
        ...
        transition: isMobile
          ? "none"
          : "width .22s cubic-bezier(.4,0,.2,1), min-width .22s, max-width .22s",
        overflow: "hidden",
        flexShrink: 0,
        zIndex: 20,
        height: "100%",
    ...
    >
      ...
      {(!collapsed || isMobile) && (
        <div
          style={{
            margin: "12px 8px 4px",
            background: "rgba(46,175,125,.08)",
            border: "1px solid rgba(46,175,125,.22)",
            borderRadius: 10,
            padding: "8px 12px",
            display: "flex",
            alignItems: "center",
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: C.coral, fontWeight: 600 }}>
              Freelancer
            </div>
          </div>
        </div>
      ...
      >
        {collapsed && !isMobile ? (
          ...
          <div
            style={{
              background:
                "linear-gradient(135deg,rgba(46,175,125,.1),rgba(46,175,125,.04))",
              border: "1px solid rgba(46,175,125,.28)",
              borderRadius: 13,
              padding: "11px 14px",
            }}
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: h
          ? `0 16px 48px rgba(0,0,0,.5),0 0 32px ${color}10`
    ...
    >
        ...
        {trend !== undefined && (
          <span
            style={{
              ...
              background:
                trend > 0 ? "rgba(68,147,66,.12)" : "rgba(239,68,68,.12)",
      ...
      {sub && (
        <div style={{ fontSize: 12, color: C.textMuted, position: "relative" }}>
          {sub}
        </div>
      )}
    </div>
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 12.5, color: C.textMuted, marginTop: 2 }}>
            Earned through verified work · shareable on any platform
          </div>
        </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: earned && h ? "translateY(-2px)" : "none",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <div
          style={{
            ...
            height: 34,
            borderRadius: 10,
            background: `${color}${earned ? "20" : "10"}`,
            border: `1px solid ${color}${earned ? "35" : "18"}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: 16,
    ...
    <GlassCard nohover glow={C.green} style={{ padding: "24px 26px" }}>
      ...
      >
        {[
          ...
          {
            label: "All Time (USDC)",
            value: `$${formatUsd(totalUsdc)}`,
            sub: `≈ ₱${phpOf(totalUsdc)}`,
            color: C.green,
          },
          {
            label: "Pending Release",
            value: `$${formatUsd(pendingRelease)}`,
            sub: `≈ ₱${phpOf(pendingRelease)}`,
            color: C.amber,
          },
      ...
      {!done ? (
        !withdrawing ? (
          ...
          >
            ...
            >
              Withdraw{" "}
              <strong style={{ color: C.text }}>
                ${formatUsd(thisMonth)} USDC
              </strong>{" "}
              → <strong style={{ color: C.text }}>₱{phpOf(thisMonth)}</strong>{" "}
              to GCash{" "}
              <code
                style={{
                  fontSize: 12,
        ...
        <div style={{ textAlign: "center", padding: "16px 0" }}>
          ...
          <div style={{ fontSize: 14, fontWeight: 700, color: C.green }}>
            Withdrawal initiated — arrives in ~3 seconds
          </div>
        </div>
      )}
    ...
    <GlassCard nohover glow={C.teal} style={{ padding: "22px 24px" }}>
      ...
      >
        ...
        <div>
          ...
          >
            Share this link with potential clients — it proves your completed
            escrows, ratings, and badges are real and on-chain.
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        {["Copy Link", "Share to LinkedIn", "Download PDF"].map((label) => (
          <Btn key={label} variant="subtle" size="sm">
            {label}
          </Btn>
        ))}
      </div>
    ...
    <div style={{ overflowX: "auto" }}>
      <div style={{ minWidth: 780 }}>
        <div
          style={{
            display: "grid",
            gridTemplateColumns: "2fr 1.4fr 1.5fr 1fr 1.1fr 1.2fr",
            padding: "11px 22px",
            borderBottom: `1px solid ${C.border}`,
            background: "rgba(255,255,255,.02)",
          }}
        >
          {["Project", "Client", "Status", "Amount", "Due Date", "Action"].map(
            (h) => (
              <div
                key={h}
                style={{
        ...
        {rows.map((row, i) => (
          <JobRow key={i} row={row} last={i === rows.length - 1} />
        ))}
      </div>
    </div>
  );
      ...
      >
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12.5, color: C.textMuted, marginTop: 2 }}>
              {active.length} contracts in progress
            </div>
          </div>
          {!showAll && (
            <Btn variant="ghost" size="sm" onClick={onViewAll}>
              View All →
            </Btn>
          )}
        </div>
        ...
        <GlassCard nohover style={{ padding: 0, overflow: "hidden" }}>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 12.5, color: C.textMuted, marginTop: 2 }}>
                {done.length} completed · funds released
              </div>
            </div>
          </div>
    ...
    >
      <div>
        ...
        <div style={{ fontSize: 11.5, color: C.textMuted }}>
          #{row.contractRef || "PGL-" + String(row.project || "").length}
        </div>
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <Avatar
        ...
        <span style={{ fontSize: 13, fontWeight: 600, color: C.text }}>
          {row.client.name || row.client.initials}
        </span>
      </div>
      <div>
      ...
      <div>
        {isActionable ? (
          ...
          <Btn variant="subtle" size="sm" onClick={handleNavigate}>
            {row.action}
          </Btn>
        )}
      </div>
  ...
  useEffect(() => {
    ...
    async function loadJobs() {
      ...
      let query = supabase
        .from("escrows")
        .select(
          "id,title,status,amount_usdc,deadline,freelancer_wallet,client_id,created_at,completed_at",
        )
      ...
      if (!error && data?.length) {
        const clientIds = [
          ...new Set((data || []).map((row) => row.client_id).filter(Boolean)),
        ];
        ...
        const clientMap = {};
        (clients || []).forEach((c) => {
          clientMap[c.id] = c.display_name || "Client";
        });
        ...
        const mapped = data.map((row) => {
          ...
          return {
            ...
            contractRef: row.id
              ? `PGL-${String(row.id).slice(0, 6).toUpperCase()}`
              : undefined,
            due: row.deadline
        ...
        setPendingRelease(
          mapped
            .filter(
              (job) =>
                job.status === "Delivered" || job.status === "Under Review",
            )
    ...
    if (user?.id) {
      supabase
        .from("deliveries")
        .select("delivery_note,created_at")
        .eq("submitted_by", user.id)
        .order("created_at", { ascending: false })
        .limit(5)
        .then(({ data }) => {
          if (mounted && data) setDeliveries(data);
        });
    }
    return () => {
      mounted = false;
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Welcome back, {freelancerName.split(" ")[0] || "Freelancer"}{" "}
                  👋
                </h1>
              </div>
              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                  ...
                  >
                    ...
                    <button
                      style={{
                        ...
                        fontFamily: C.font,
                        background:
                          "linear-gradient(135deg,rgba(46,175,125,.2),rgba(46,175,125,.08))",
                        boxShadow: "inset 0 0 0 1px rgba(46,175,125,.28)",
                        color: C.coral,
                        fontSize: 12,
                        fontWeight: 700,
                      }}
            ...
            >
              ...
              <StatCard
                ...
                value={`$${formatUsd(earningsThisMonth)}`}
                sub={`≈ ₱${phpOf(earningsThisMonth)}`}
                color={C.coral}
                trend={18}
              />
              <StatCard
            ...
            {/* Bottom row */}
            <div
              className="freelancer-bottom-grid"
              style={{ display: "grid", gap: 18, marginBottom: 22 }}
            >
              <EarningsSummary
                totalUsdc={earningsTotal}
                thisMonth={earningsThisMonth}
                pendingRelease={pendingRelease}
                jobsDone={statsCompleted}
...
export default function PangolinFreelancer() {
  ...
  const {
    wallet,
    connectWallet: rootConnectWallet,
    disconnectWallet: rootDisconnectWallet,
  } = useFreighterWallet();
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      const { data: escrow } = await supabase
        .from("escrows")
        .select(
          "id,title,category,amount_usdc,min_guarantee_pct,min_guarantee_usdc,deadline,client_id,stellar_contract_id",
        )
      ...
      if (escrow) {
        ...
        const minUsdc = Number(
          escrow.min_guarantee_usdc ?? (totalUsdc * minPct) / 100,
        );
        setInviteData({
          ...
          deadline: escrow.deadline
            ? new Date(escrow.deadline).toLocaleDateString("en-US", {
                month: "short",
                day: "numeric",
                year: "numeric",
              })
    ...
    <AuthGuard>
      ...
      `}</style>
          ...
          >
            <div
              style={{
                ...
                height: 36,
                borderRadius: "50%",
                border: `3px solid rgba(63,208,201,.2)`,
                borderTop: `3px solid #3FD0C9`,
            ...
            <div style={{ width: "100%", maxWidth: 400, textAlign: "center" }}>
              <div
                style={{
                  ...
                  border: `1px solid rgba(10,85,96,.8)`,
                  borderRadius: 14,
                  padding: "10px 22px",
              ...
              >
                Link your Freighter wallet to your account. Once linked, we'll
                check if any client has an escrow waiting for your wallet
                address.
              </p>
              {walletError && (
                <div
        ...
        {screen === "B" && (
          <div
            key="B"
            style={{ height: "100vh", animation: "fade-up .3s ease" }}
          >
            <ScreenB
              onSwitchToInvite={() => setScreen("A")}
